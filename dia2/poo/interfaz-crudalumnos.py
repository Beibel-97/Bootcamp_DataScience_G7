...
class TkAlumno:
    ...
    def __init__(self,app):
        ...
        self.btn_actualizar.grid(row=6,column=0,columnspan=2)
        
        self.btn_eliminar = Button(frame,text='Eliminar Alumno',command=self.eliminar_alumno)
        self.btn_eliminar.grid(row=7,column=0,columnspan=2)
    ...
    def actualizar_alumno(self):
        if not self.item_seleccionado:
            messagebox.showerror("Error", "CARGUE UNN ALUMNO PARA EDITAR")
            return
